...
@section('content')
<div class="bg-gradient-to-r from-blue-600 to-indigo-700 min-h-screen flex flex-col justify-center items-center text-center px-4 py-20">
...
<div class="max-w-6xl mx-auto mt-10 px-4 py-10 bg-white rounded-lg shadow">
    <h1 class="text-3xl font-bold mb-8 text-center text-gray-900">Наши консультанты</h1>
    ...
    @else
        <div class="grid gap-8 sm:grid-cols-2 md:grid-cols-3">
            ...
            border border-transparent hover:border-blue-500 focus-within:border-blue-500 outline-none">
    <div class="w-32 h-32 mb-4 rounded-full overflow-hidden border-4 border-blue-600 shadow-sm
    ...
    <h2 class="text-2xl font-bold mb-2 text-gray-900">{{ $consultant->name }}</h2>
    <p class="text-gray-700 mb-6 line-clamp-4">{{ $consultant->description ?? 'Описание отсутствует' }}</p>
    <a href="{{ route('consultations.create', ['consultant_id' => $consultant->id]) }}"
       class="mt-auto inline-block bg-blue-600 text-white px-6 py-3 rounded-full
